...
- [x] turnip_mrpurple-T18-toasted.adpkg.so (maybe fix VRAM error for Tao and Mir effects, but may also cause some issues when using turnip mr purple)
- [x] turnip_mrpurple-T19-toasted.adpkg.so (maybe fix VRAM error for Tao and Mir effects, but may also cause some issues when using turnip mr purple)
- [x] turnip_mrpurple-T21-toasted.adpkg.so (maybe fix VRAM error for Tao and Mir effects, but may also cause some issues when using turnip mr purple)
- [x] turnip_mrpurple_T21-AYANEO.adpkg.so (maybe fix VRAM error for Tao and Mir effects, but may also cause some issues when using turnip mr purple)
- [x] turnip_mrpurple_T26-toasted.adpkg.so (maybe fix VRAM error for Tao and Mir effects, but may also cause some issues when using turnip mr purple)
